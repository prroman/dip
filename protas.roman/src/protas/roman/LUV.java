...
public class LUV extends javax.swing.JFrame {
    ...
    private double RGB[],XYZ[],Luv[];
    private double Yn = 1;
    private double Un = 0.2009;
    private double Vn = 0.4610;
    private double E = 0.008856;
    private double k = 903.3;
    
    public LUV(BufferedImage image, Main parent) {
        this.parent = parent;
    ...
    private void rysuj() {
        ...
        double du = Double.parseDouble(aSpinner.getValue().toString());
        double dv = Double.parseDouble(bSpinner.getValue().toString());
        ...
        for (int x = 0; x < this.image.getWidth(); x++) {
            for (int y = 0; y < this.image.getHeight(); y++) {
                ...
                double ur = 9 * Y/(Xr + 15 * Yr + 3 * Zr);
                double v_ = 9 * X/(X + 15 * Y + 3 * Z);
                double vr = 9 * Y/(Xr + 15 * Yr + 3 * Zr);
                l = (k * yr) + dl;
                u = (13 * l * (u_ - ur)) + du;
                v = (200 * (v_ - vr)) + dv;
                //LabtoXYZ
    ...
    private void initComponents() {
        ...
        labelTable3.put( new Integer(-134), new JLabel("-134") );
        labelTable3.put( new Integer(0), new JLabel("0") );
        labelTable3.put( new Integer(220), new JLabel("220") );
        lSlider.setLabelTable( labelTable3 );
        lSlider.setMajorTickSpacing(220);
        lSlider.setMinorTickSpacing(-134);
        ...
        labelTable2.put( new Integer(-140), new JLabel("-140") );
        labelTable2.put( new Integer(0), new JLabel("0") );
        labelTable2.put( new Integer(122), new JLabel("122") );
        bSlider.setLabelTable( labelTable2 );
        bSlider.setMajorTickSpacing(122);
        bSlider.setMinorTickSpacing(-140);
